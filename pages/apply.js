        ...
        <div className="main flex flex-row justify-center items-center w-full mx-1">
          <div className="content flex flex-col justify-center items-center mx-auto w-1/2 ">
            <div className="border-2  p-2 rounded-xl bg-white">
              ...
              <p className="text-center">Create your own LinkTree 🐱</p>
              <form
                onSubmit={handleRegister}
                className="flex flex-col justify-center items-center mx-auto"
              >
                <span className="shadow-md border-2  my-2 px-2 py-1 w-2/3 flex flex-row items-center">
                  <svg
                    className="inline"
                    width="15"
                    height="15"
            ...
            <h4 className="text-center text-white pt-3">
              Already Registered?{" "}
              <Link className="font-bold text-red-200" href="/login">
                Login
              </Link>
            </h4>
          </div>
